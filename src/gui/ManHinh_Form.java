...
public class ManHinh_Form extends JPanel {
    ...
    public void doShow(){
        ...
        JLabel lblTieuDe = new JLabel("Màn Hình Máy Tính");
        ...
        List<LinhKien> ls = lkDao.TimKiemLoai("LLK001");
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/images_LinhKien/mhhp2.png"));
//        lbImages1.setPreferredSize(new Dimension(110,110));
        ...
        icon2 = new ImageIcon(getClass().getResource("/images_LinhKien/mhcong.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon3 = new ImageIcon(getClass().getResource("/images_LinhKien/lenovo1.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon4 = new ImageIcon(getClass().getResource("/images_LinhKien/dell1.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
                        ...
                        GioHang gh = null;
                            if(ctGioHangDao.getLS(ghDao.TimKiemMaKH(kh.getMaKH()).getMaGH()).size() != 0){
                                for (CT_GioHang ct: ctGioHangDao.getLS(ghDao.TimKiemMaKH(kh.getMaKH()).getMaGH())) {
                                    ...
                                    if(!ct.getLinhKien().getMaLK().equalsIgnoreCase(lk1.getMaLK())){
                                        gh = ghDao.TimKiemMaKH(kh.getMaKH());
                                        System.out.println("GioHang-----:"+gh);
                                        CT_GioHang ctgh = new CT_GioHang(1);

                                        ctgh.setLinhKien(lk1);ctgh.setGioHang(gh);ctgh.setThanhTien(lk1.getDonGia()* ctgh.getSoLuong());
                                        ...
                                        ctGioHangDao.updateCTGH(ghDao.TimKiemMaKH(kh.getMaKH()).getMaGH(),lk1.getMaLK(),1+ct.getSoLuong());
//
                                        lkDao.updateSoLuong(lk1.getMaLK(),lkDao.TimKiemMa(lk1.getMaLK()).getSoLuong() - 1);
                                    }
...
//
                        ...
                        removeAll();
                        GioHang_Form gh1 = new GioHang_Form();
                        gh1.kh = kh;
                        gh1.doShow();
                        add(gh1);
                        validate();
...
//                pnN11.setVisible(false);
        ...
        ImageIcon icon5 = new ImageIcon(getClass().getResource("/images_LinhKien/asus1.png"));
//        lbImages1.setPreferredSize(new Dimension(110,110));
        ...
        icon6 = new ImageIcon(getClass().getResource("/images_LinhKien/lenovo2.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon7 = new ImageIcon(getClass().getResource("/images_LinhKien/asus3.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon8 = new ImageIcon(getClass().getResource("/images_LinhKien/mhhp.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
