...
public class MainBoard_Form extends JPanel {
    JPanel pnNorth,pnCenter;
    KhachHang kh;

    public MainBoard_Form(){
    ...
    public void doShow(){
        ...
        JLabel lblTieuDe = new JLabel("MainBoard - Bo mạch chủ");
        ...
        List<LinhKien> ls = lkDao.TimKiemLoai("LLK004");
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/images_LinhKien/bmc.png"));
//        lbImages1.setPreferredSize(new Dimension(110,110));
        ...
        icon2 = new ImageIcon(getClass().getResource("/images_LinhKien/asu.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon3 = new ImageIcon(getClass().getResource("/images_LinhKien/ark.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon4 = new ImageIcon(getClass().getResource("/images_LinhKien/ism.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
...
//                pnN11.setVisible(false);
        ...
        ImageIcon icon5 = new ImageIcon(getClass().getResource("/images_LinhKien/asv2.png"));
//        lbImages1.setPreferredSize(new Dimension(110,110));
        ...
        icon6 = new ImageIcon(getClass().getResource("/images_LinhKien/auss.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon7 = new ImageIcon(getClass().getResource("/images_LinhKien/pp.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon8 = new ImageIcon(getClass().getResource("/images_LinhKien/mns.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
